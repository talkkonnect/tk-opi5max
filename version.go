...
const (
	talkkonnectVersion  string = "orangepi5max-2.43.03"
	talkkonnectReleased string = "13 July 2025"
)


/* Release Notes
version orangepimax5-2.42.03
changed library to work with orangepi 5 max gpio for input and output
removed external mcp chip gpio which is not needed
